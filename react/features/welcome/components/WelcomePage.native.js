...
import SynziRootView from '../../../synzi/_shared/src/views/SynziRootView/SynziRootView'
...
class WelcomePage extends AbstractWelcomePage {
    ...
    constructor(props) {
        ...
        this.state.typedRoomName = AppConfig.RoomName;
    ...
    render() {
        ...
        Reactotron.warn("WelcomePage.native.js Return <ApolloProvider><SynziRootView /></ApolloProvider>")
        /** Entry Point for Synzi App */
        return (
            <ApolloProvider client={global.SYNZI_client}>
                <SynziRootView
                    {...rest}
                />
            </ApolloProvider>
