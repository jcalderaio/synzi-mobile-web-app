...
/**
 * Tells Synzi code that we hung up the conference.
 *
 * @param {boolean} hangupPressed - set to true when pressed.
 * @returns {{
 *     type: HANG_UP_PRESSED,
 *     visible: hangupPressed
 * }}
 */
export function setHangupPressed(hangupPressed: boolean): Object {
    return {
        type: HANG_UP_PRESSED,
        hangupPressed
    };
