...
(global => {
    ...
    if (typeof global.document === 'undefined') {
        ...
        // FIXME There is a weird infinite loop related to Reactotron.log and
        // Document and/or Element at the time of this writing. Work around it
        // by patching Node and/or overriding Reactotron.log.
                        ...
                        console[level] = function(...args) {
                            ...
                            for (let i = 0; i < length; ++i) {
                                ...
                                if (arg
                                        ...
                                        // Limit the Reactotron.log override to
                                        // Node (instances).
