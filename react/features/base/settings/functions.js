...
import { AppConfig } from '../../../synzi/_shared/constants/AppConfig'
import EnvManager from '../../../synzi/_shared/services/EnvManager'
...
export function getServerURL(stateful: Object | Function) {
    //return 'https://jitsi.qa.synzi.com'
    return EnvManager.getInstance().getJitsiUrl() ? EnvManager.getInstance().getJitsiUrl() : 'https://beta.meet.jit.si';;
}
